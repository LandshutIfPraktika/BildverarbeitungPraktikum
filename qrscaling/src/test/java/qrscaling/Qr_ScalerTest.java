...
public class Qr_ScalerTest {
    ...
    public void test_check_one_vertical() {
        ...
        final int centreRow = qrFinder.crossCheck(possiblePattern.row, centreCol, possiblePattern.pixelCounts[2], possiblePattern.result.totalPixelCount, possiblePattern.pixels, byteProcessor.getWidth());
    ...
    public void test_check_two_vertical() {
        ...
        final int firstCentreRow = qrFinder.crossCheck(firstPattern.row, firstCentreCol, firstPattern.pixelCounts[2], firstPattern.result.totalPixelCount, firstPattern.pixels, byteProcessor.getWidth());
        ...
        final int centreRow = qrFinder.crossCheck(secondPattern.row, centreCol, secondPattern.pixelCounts[2], secondPattern.result.totalPixelCount, secondPattern.pixels, byteProcessor.getWidth());
        assertEquals(4, centreRow);
    }
    ...
    public void test_check_one_complete() {
        ...
        final int centreRow = qrFinder.crossCheck(possiblePattern.row, centreCol, possiblePattern.pixelCounts[2], possiblePattern.result.totalPixelCount, possiblePattern.pixels, byteProcessor.getWidth());
        assertEquals(4, centreRow);
        centreCol = qrFinder.crossCheck(centreRow, centreCol, possiblePattern.pixelCounts[2], possiblePattern.result.totalPixelCount, possiblePattern.pixels, 1) % byteProcessor.getWidth();
        assertEquals(4, centreCol);
        final int diagonal = qrFinder.crossCheck(centreRow, centreCol, possiblePattern.pixelCounts[2], possiblePattern.result.totalPixelCount, possiblePattern.pixels, 1 + byteProcessor.getWidth());
